...
interface AppState {
  currentView: 'landing' | 'community' | 'archive' | 'admin-login' | 'admin-dashboard' | 'experiences' | 'tourism' | 'bookings' | 'about-sikkim' | 'foods' | 'dance' | 'jewellery' | 'languages' | 'instruments';
